...
public class Bookstore {
    ...
    @TableGenerator(name = "generator_wartosci", table = "tabela_generator_wartosci", initialValue = 75, allocationSize = 25, pkColumnValue = "id_tabela_bookstore", pkColumnName = "tabele", valueColumnName = "wartosc_id")
